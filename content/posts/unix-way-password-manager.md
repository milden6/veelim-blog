...
Не буду расписывать о правилах создания и хранения паролей, так как это дело каждого. Однако, если вы используете один пароль везде или считаете, что ваши данные никому не нужны это, конечно, грустно.
